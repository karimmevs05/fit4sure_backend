...
async function rebuildInventory() {
  try {
    ...
    const inventoryData = [
      ...
      { name: 'Ground Turkey', category: 'Protein', store: 'Costco', grade: 'Organic', net_weight_g: 1361, price_per_pound: 5.00, serving_size_g: 141.7, servings_per_container: 9.6, price_total_cents: 1999, price_per_serving_cents: 271, date_purchased: '2024-11-27' },
      ...
      { name: 'Ribeye Grassfed & Finished', category: 'Protein', store: 'Aldi', grade: 'Grass-fed', net_weight_g: 454, price_per_pound: 11.49, serving_size_g: 141.7, servings_per_container: 3.2, price_total_cents: 1149, price_per_serving_cents: 467 },
      ...
      { name: 'Spring Mix', category: 'Vegetables', store: 'Costco', grade: 'Organic', net_weight_g: 454, price_per_pound: 4.49, serving_size_g: 100, servings_per_container: 4.54, price_per_serving_cents: 100 },
      ...
      { name: 'Carrots', category: 'Vegetables', store: 'Costco', grade: 'Rainbow', net_weight_g: 907, price_per_pound: 1.37, serving_size_g: 80, servings_per_container: 11.3, price_total_cents: 549, price_per_serving_cents: 61, date_purchased: '2024-11-26' },
      ...
      // PACKAGING
      { name: '32 OZ Fiber To-Go Boxes', category: 'Packaging', store: 'Good Start Packaging', net_weight_g: null, price_total_cents: 14030, servings_per_container: 400, price_per_serving_cents: 35 },
      { name: '32 OZ Fiber to-Go PLA Lids', category: 'Packaging', store: 'Good Start Packaging', net_weight_g: null, price_total_cents: 14350, servings_per_container: 400, price_per_serving_cents: 36 },
      { name: 'Paper Bags 10x6.75x12', category: 'Packaging', net_weight_g: null, price_total_cents: 9280, servings_per_container: 250, price_per_serving_cents: 37 },
      { name: 'Paper Bags 14x10x16', category: 'Packaging', net_weight_g: null, price_total_cents: 11490, servings_per_container: 200, price_per_serving_cents: 57 },
      { name: 'Salad Bowl PLA 32 Oz', category: 'Packaging', net_weight_g: null, price_total_cents: 18420, servings_per_container: 600, price_per_serving_cents: 31 },
      { name: 'Square 32 Oz Fiber Bowl', category: 'Packaging', net_weight_g: null, price_total_cents: 10930, servings_per_container: 400, price_per_serving_cents: 27 },
      { name: '20Oz Fiber Box (Breakfast)', category: 'Packaging', net_weight_g: null, price_total_cents: 11780, servings_per_container: 400, price_per_serving_cents: 29 },
    ];
